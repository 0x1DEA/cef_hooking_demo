...
bool WebCoreManager::setUp(int *exit_code)
{
    ...
    CefMainArgs args(GetModuleHandleA(0));
    ...
    settings.remote_debugging_port = 42069;
    settings.log_severity = LOGSEVERITY_VERBOSE;
    CefString(&settings.browser_subprocess_path) = R"(C:\Program Files (x86)\Steam\steamapps\common\Geometry Dash\lotus_sub.exe)";
        ...
        : mouse_x_(0), mouse_y_(0)
{
    ...
    browser_ = CefBrowserHost::CreateBrowserSync(window_info, client_.get(), url, browserSettings, nullptr, nullptr);
}
